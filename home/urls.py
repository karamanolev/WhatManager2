...
urlpatterns = [
    ...
    url(r'^checks$', views.checks, name='home-checks'),
    url(r'^stats$', views.stats, name='home-stats'),
    ...
    url(r'^part/checks', parts.checks, name='home-checks'),
    ...
    url(r'^part/stats$', parts.stats, name='home-stats'),
]
